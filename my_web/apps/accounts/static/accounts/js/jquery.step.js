...
(function (factory) {
    ...
    if (typeof define === 'function') {
      ...
      define.cmd&&define('jquery-step', ['apps/accounts/static/accounts/js/jquery'], function (require, exports, moudles) {
            var $=require("apps/accounts/static/accounts/js/jquery");
            factory($);
            return $;
        });
      define.amd&&define(['apps/accounts/static/accounts/js/jquery'], factory);
    } else {
